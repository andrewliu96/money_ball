...
var environment_id;
var collection_id;
const DEFAULT_NAME = 'nba-austin-data';
var discoveryDocs = [];
const fs = require('fs');
const path = require('path');
var arrayOfFiles = fs.readdirSync('./data/nba/');
arrayOfFiles.forEach(function(file) {
  discoveryDocs.push(path.join('./data/nba/', file));
});
...
const discoverySetupParams = { 
  ...
  config_name: 'nba-keyword-extraction'   // instead of 'Default Configuration'
};
